...
//CODE HERE
var foundZ = nestedLetters[5][2][1];
...
//CODE HERE
var bestMovie = (movie) => `${movie} is the best movie ever!`
////////////////////PROBLEM 6////////////////////
/*
...
//CODE HERE
  var jsNinja = () => 'I am a JavaScript ninja!'
...
//     for ( let j = lettersToPair.length-1; j>= 0; j--) {
//         if (lettersToPair[i] == lettersToPair[j]) {
//             pairsArray.push(lettersToPair.indexOf[i][j])
//         }
//     }
// }
...
//CODE HERE
  let phone1 = new Phone('Nokia', 'PureView', 5, 'red', false)
  
  let phone2 = new Phone('Apple', 'Iphone', 10, 'blue', false)
  
  let phone3 = new Phone('Samsung', 'Galaxy', 15, 'green', false)
